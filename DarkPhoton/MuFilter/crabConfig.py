...
config.General.requestName = 'Dphoton_MuPlusXSkim_run2018DUL_1stHalf'
...
config.Data.userInputFiles = open('/uscms_data/d3/revering/CMSSW_10_6_4_patch1/src/DarkPhoton/MuFilter/Run2018D_UL2018_v4_1stHalf.txt').readlines()
